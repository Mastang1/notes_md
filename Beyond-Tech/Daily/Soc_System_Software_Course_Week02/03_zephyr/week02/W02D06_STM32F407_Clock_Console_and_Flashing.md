...
- `SRC-F407-SCH`：p.2、p.4 必看。
- `SRC-ST-F407-DATASHEET`：PA9/PA10 alternate functions 和 exact part memory。
- `SRC-ZEPHYR-BOARD-PORTING`：board DTS/defconfig/board.cmake。
- `SRC-ZEPHYR-WEST-BUILD`：`west flash`、runner、debug。
