...
- **ALIENTEK I.MX6U Embedded Linux Driver Development Guide V1.5.2**  
  ...
  Read: Re-read Chapter 35 §35.2/§35.3 only for clean build/artifact evidence; for DT mechanism use the course DeviceTree deep-dive and official kernel/Zephyr docs.

### 7.2 Official references

- [Linux DeviceTree usage model](https://docs.kernel.org/translations/zh_CN/devicetree/usage-model.html)
